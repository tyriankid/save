...
public class UITextList : MonoBehaviour
{
	...
	protected void Add (string text, bool updateVisible)
	{
        ...
        if (textLabel != null)
		{
            ...
            else if (textLabel.trueTypeFont != null)
            {
                NGUIText.WrapText(text, textLabel.trueTypeFont, textLabel.fontSize, textLabel.fontStyle, textLabel.width, 100000, 0, textLabel.supportEncoding, out line);
            }
            else
                return;
    ...
    protected void UpdateVisibleText()
    {
        ...
        {
            int lines = 0;
            int maxLines = maxHeight > 0 ? Mathf.FloorToInt(maxHeight / textLabel.fontSize * (textLabel.bitmapFont != null ? textLabel.bitmapFont.pixelSize : 1)) : 100000;
